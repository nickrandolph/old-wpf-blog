...
namespace GroupingTreeView.Desktop
{
    public class Animal
    {
        private string name;
    ...
    public class CategorisedAnimals
    {
        public IGrouping<Category,Animal>[] AnimalGroups { get; set; }

        public CategorisedAnimals()
        {
            AnimalGroups = (from animal in (new Animals().AnimalList)
                       group animal by animal.Category).ToArray();
